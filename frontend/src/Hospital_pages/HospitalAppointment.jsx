...
const HospitalAppointments = () => {
    ...
    useEffect(() => {
        const fetchAppointments = async () => {
            ...
            try {
                const res = await axios.get(`https://docfinder-3pkx.onrender.com/api/appointments/hospital/${correctId}`);
    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            await axios.put(`https://docfinder-3pkx.onrender.com/api/appointments/complete/${selectedAppointmentId}`);
        } catch (err) {

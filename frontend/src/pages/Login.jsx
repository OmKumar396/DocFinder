...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://docfinder-3pkx.onrender.com/api/login/user', {
        method: 'POST',
  ...
  const sendOtp = async () => {
    try {
      const res = await fetch('https://docfinder-3pkx.onrender.com/api/forgot-password/send-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const verifyOtpAndReset = async () => {
    try {
      const res = await fetch('https://docfinder-3pkx.onrender.com/api/forgot-password/reset', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
